...
import { CloseOutlined } from './PixelIcons'
import type { GraphNode, WorkflowEdge, WorkflowNodeType } from '../lib/xiyueWorkshopWorkflow'
import { getStitchInputSlotCount, WORKFLOW_DRAG_INPUT_IMAGE_INDEX } from '../lib/xiyueWorkshopWorkflow'
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderRadius: 0,
                  border: sel ? '3px solid #C89332' : '2px solid #2D2926',
                  background: '#263746',
                  boxShadow: sel ? '5px 5px 0 #C89332' : '4px 4px 0 #2D2926',
                  zIndex: sel ? 4 : 2,
                }}
              ...
              >
                {n.type === 'matteDoubleBackground' ? (
                  <>
                    <div
                      title={tHint('xiyueWorkshopWorkflowPinInBlack')}
                      style={{
                        position: 'absolute',
                        left: -10,
                    ...
                    />
                    <div
                      title={tHint('xiyueWorkshopWorkflowPinInWhite')}
                      style={{
                        position: 'absolute',
                        left: -10,
                  ...
                  Array.from({ length: getStitchInputSlotCount(n) }, (_, i) => i + 1).map((slot) => (
                    <div
                      key={slot}
                      title={tHint('xiyueWorkshopWorkflowPinInStitchN', { n: slot })}
                      style={{
                        position: 'absolute',
                        left: -10,
                  ...
                  <div
                    title={tHint('xiyueWorkshopWorkflowPinIn')}
                    style={{
                      position: 'absolute',
                      left: -10,
                ...
                <div
                  title={tHint('xiyueWorkshopWorkflowPinOut')}
                ...
                <div
                  ...
                  className="xiyue-blueprint-node-body"
                >
                  {renderNodeBody(n)}
                </div>
              </div>
      ...
      <div style={{ fontSize: 11, color: '#888' }}>
        <div>{tHint('xiyueWorkshopWorkflowBlueprintControls')}</div>
        {onToolPlaceAt && <div style={{ marginTop: 4 }}>{tHint('xiyueWorkshopWorkflowBlueprintHotkeys')}</div>}
      </div>
    </div>
  )
}
