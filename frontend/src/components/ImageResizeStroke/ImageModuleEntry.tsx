...
import { EditOutlined, ScissorOutlined } from '../PixelIcons'
    ...
    <div style={{ padding: '24px 0' }}>
      ...
      <Row gutter={24} justify="center">
        <Col xs={24} sm={12} md={8}>
          ...
          >
            <ScissorOutlined style={{ fontSize: 40, color: '#A94332', marginBottom: 16 }} />
        ...
        <Col xs={24} sm={12} md={8}>
          ...
          >
            <EditOutlined style={{ fontSize: 40, color: '#A94332', marginBottom: 16 }} />
