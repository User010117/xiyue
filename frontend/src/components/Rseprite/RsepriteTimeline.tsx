import { CopyOutlined, DeleteOutlined } from '../PixelIcons'
  ...
  return (
    ...
    >
      <Typography.Text strong style={{ display: 'block', marginBottom: 8, fontSize: 13 }}>
        {t('xiyueWorkshopRsepriteTimelineTitle')}
      </Typography.Text>
      <Space wrap align="center" style={{ marginBottom: 10 }}>
        <Typography.Text type="secondary" style={{ fontSize: 12 }}>
          {t('xiyueWorkshopRsepriteFrameDurationLabel')}
        </Typography.Text>
        <Space size={4}>
          <InputNumber
            size="small"
        ...
        <Typography.Text type="secondary" style={{ fontSize: 11 }}>
          {t('xiyueWorkshopRsepriteFrameDurationHint')}
        </Typography.Text>
      </Space>
      <Space wrap align="start" size={8}>
        ...
        <Space direction="vertical" size={4} style={{ marginLeft: 4 }}>
          <Button type="dashed" size="small" icon={<CopyOutlined />} onClick={onDuplicateFrame}>
            {t('xiyueWorkshopRsepriteTimelineDuplicate')}
          </Button>
          <Button
            danger
            size="small"
          ...
          >
            {t('xiyueWorkshopRsepriteTimelineDelete')}
          </Button>
        </Space>
      </Space>
    </div>
