...
export default function XiyueWorkshopScatterSlice() {
  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <Space direction="vertical" size={18} style={{ width: '100%' }}>
        ...
        <Row gutter={[18, 18]}>
          <Col span={24}>
            <Card styles={{ body: { padding: 18 } }} style={{ ...PANEL_STYLE, minHeight: 760 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, alignItems: 'flex-start', flexWrap: 'wrap' }}>
              ...
              <Space wrap size={[12, 8]} style={{ justifyContent: 'flex-end' }}>
                ...
                <div style={{ minWidth: 90, borderRadius: 0, padding: '8px 10px', background: '#F2E8D5', border: '2px solid #2D2926' }}>
            ...
            <div style={{ marginTop: 18, borderRadius: 0, minHeight: 620, position: 'relative', overflow: 'hidden', border: '2px solid #2D2926', background: 'repeating-conic-gradient(#D8CBB5 0% 25%, #FFF8E8 0% 50%) 50% / 24px 24px' }}>
