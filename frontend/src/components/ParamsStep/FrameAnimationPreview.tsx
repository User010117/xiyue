...
import { CaretLeftOutlined, CaretRightOutlined, PauseOutlined, PlayCircleOutlined } from '../PixelIcons'
    ...
    <div style={{ marginTop: 16, marginBottom: 16 }}>
      ...
      >
        ...
        {onRangeSample && selectedIndices.length > 0 && (
          <div style={{ marginTop: 16, padding: 12, background: '#D8CBB5', borderRadius: 0, border: '1px solid #6E6258' }}>
