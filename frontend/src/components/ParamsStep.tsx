...
import { DownloadOutlined, ExpandOutlined, ReloadOutlined, RetweetOutlined, UndoOutlined } from './PixelIcons'
...
function CropCanvasEditor({
  ...
  useEffect(() => {
    ...
    img.onload = () => {
      ...
      ctx.strokeStyle = '#A94332'
      ctx.lineWidth = 2
      ctx.strokeRect(left, top, w, h)
      ctx.fillStyle = '#A94332'
      ;[
  ...
  return (
    <div style={{ marginTop: 8, overflow: 'auto', maxHeight: 400, border: '1px solid #2D2926', borderRadius: 8 }}>
      <canvas
        ref={canvasRef}
        width={videoSize.w}
        height={videoSize.h}
    ...
    <div style={{ paddingTop: 8 }}>
      {file && videoUrl && (
        <>
          ...
          {extracting && (
            ...
            {videoSize && mattedFrames.length === 0 && (
              <Col xs={24} md={10}>
                <div style={{ padding: 16, border: '1px solid #2D2926', borderRadius: 0, background: '#D8CBB5' }}>
          ...
          {extractedFrames.length > 0 && !extracting && (
            <>
              ...
              <div style={{ display: 'flex', gap: 16, marginBottom: 16, flexWrap: 'wrap' }}>
                <div
                  style={{ flex: 1, minWidth: 200, border: '1px solid #2D2926', borderRadius: 0, overflow: 'hidden', padding: 8 }}
                >
                ...
                <div
                  style={{
                    ...
                    overflow: 'hidden',
                    padding: 8,
                    background: mattePreviewBgSolid ? '#a63d2e' : 'repeating-conic-gradient(#D8CBB5 0% 25%, #D8CBB5 0% 50%) 50% / 16px 16px',
                  }}
                >
                  ...
                  {mattePreviewUrl ? (
                    ...
                    <div style={{ textAlign: 'center', padding: 40, color: '#6E6258' }}>
                    ...
                    {mattedFrames.map((f, i) => (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: 0,
                          overflow: 'hidden',
                          background: 'repeating-conic-gradient(#6E6258 0% 25%, #FFF8E8 0% 50%) 50% / 12px 12px',
                        }}
                      >
                        <img
                          src={f.dataUrl}
        ...
        {mattedFrames.length > 0 && (() => {
          ...
          return (
            <div style={{ marginBottom: 24, padding: 16, border: '1px solid #2D2926', borderRadius: 0, background: '#D8CBB5' }}>
                  ...
                  <Space wrap>
                    {sizePresets.map(([w, h]) => (
                      <Button
                        ...
                        type="primary"
                        ghost
                        style={{ borderColor: '#A94332', color: '#A94332' }}
