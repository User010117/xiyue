...
| 产品线 | **XiyueWorkshop**：自定义缩放、切片、统一尺寸；NFT 开关 `frontend/src/config/features.ts` | 深链 **R** → 自定义缩放 |
| 首页结构 | XiyueWorkshop 置于 Seedance + 素材分享之前 | `ModeSelector.tsx` |
...
| Sprite Sheet / 调整 | 拆分、合成 GIF、勾选与预览、重组合 | 纯前端（调整需 Xiyue） | `SpriteSheetTool`、`SpriteSheetAdjust` |
| XiyueWorkshop | 缩放/切片/统一尺寸 | 纯前端 | `XiyueWorkshop*.tsx` |
